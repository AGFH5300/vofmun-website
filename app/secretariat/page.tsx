              ...
              >
                ...
                {modalFounder.linkedin?.trim() ? (
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-[#0077B5] px-4 py-2 text-sm font-semibold text-white shadow-md transition-all hover:bg-[#005885] hover:scale-105"
                  >
